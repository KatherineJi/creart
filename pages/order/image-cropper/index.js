...
Page({
  ...
  submit() {
    this.cropper.getImg((obj) => {
      console.log(obj, this.data.source);
      app.globalData.tempCropperData = obj;
      app.globalData.tempCropperOriginData = this.data.src;
      // wx.setStorageSync("tempCropperData", obj);
      wx.navigateBack({
        delta: +this.data.source,
      })
    });
  },
  rotate() {
